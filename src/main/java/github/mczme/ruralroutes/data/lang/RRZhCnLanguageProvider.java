...
public class RRZhCnLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("gui.ruralroutes.trade_atlas.action.select_node", "选节点");
        add("gui.ruralroutes.trade_atlas.action.select_route", "选商路");
        add("gui.ruralroutes.trade_atlas.action.show_route", "显示");
        add("gui.ruralroutes.trade_atlas.action.hide_route", "隐藏");
        add("gui.ruralroutes.trade_atlas.detail.empty", "请选择一个节点查看");
        add("gui.ruralroutes.trade_atlas.detail.none", "未选中");
        add("gui.ruralroutes.trade_atlas.detail.current_target", "当前目标");
        add("gui.ruralroutes.trade_atlas.detail.visible_routes", "显示商路");
        add("gui.ruralroutes.trade_atlas.detail.pending_clue", "待确认线索");
        add("gui.ruralroutes.trade_atlas.detail.related_routes", "显示中商路");
        add("gui.ruralroutes.trade_atlas.detail.interactions", "交互");
        add("gui.ruralroutes.trade_atlas.detail.hint.click_select", "单击节点/路段/标记查看");
        add("gui.ruralroutes.trade_atlas.detail.hint.double_route", "双击路段/标记选商路");
        add("gui.ruralroutes.trade_atlas.detail.hint.single_route_node", "双击单商路节点选商路");
        add("gui.ruralroutes.trade_atlas.detail.hint.multi_route_marker", "多商路节点请双击标记");
        add("gui.ruralroutes.trade_atlas.detail.hint.blank_drag", "单击空白清空并拖动画布");
        add("gui.ruralroutes.trade_atlas.detail.hint.visible_only", "图中只操作已显示商路");
        ...
        add("gui.ruralroutes.trade_atlas.detail.visible", "显示");
        add("gui.ruralroutes.trade_atlas.detail.route", "所属商路");
        add("gui.ruralroutes.trade_atlas.detail.node", "引用节点");
        add("gui.ruralroutes.trade_atlas.detail.from", "起点");
        add("gui.ruralroutes.trade_atlas.detail.to", "终点");
        add("gui.ruralroutes.trade_atlas.detail.direction", "方向");
        add("gui.ruralroutes.trade_atlas.detail.role", "角色");
        add("gui.ruralroutes.trade_atlas.detail.note", "备注");
        add("gui.ruralroutes.trade_atlas.map.player", "玩家当前位置");
        add("gui.ruralroutes.trade_atlas.map.zoom", "缩放 %s%%");
        add("gui.ruralroutes.trade_atlas.map.center_selected", "选");
        add("gui.ruralroutes.trade_atlas.map.center_player", "我");
        add("gui.ruralroutes.trade_atlas.map.center_target", "目");
        ...
        add("gui.ruralroutes.trade_atlas.route.new_route_hint", "选中节点后新建商路");
        add("gui.ruralroutes.trade_atlas.route.pick_endpoint_hint", "起点 %s，选择终点");
        ...
        add("gui.ruralroutes.trade_atlas.route.action.new", "新商路");
        add("gui.ruralroutes.trade_atlas.route.action.cancel_new", "取消新建");
