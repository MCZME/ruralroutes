...
public class RREnUsLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("gui.ruralroutes.trade_atlas.action.select_node", "Select Node");
        add("gui.ruralroutes.trade_atlas.action.select_route", "Select Route");
        add("gui.ruralroutes.trade_atlas.action.show_route", "Show");
        add("gui.ruralroutes.trade_atlas.action.hide_route", "Hide");
        add("gui.ruralroutes.trade_atlas.detail.empty", "Select a node to inspect");
        add("gui.ruralroutes.trade_atlas.detail.none", "Nothing Selected");
        add("gui.ruralroutes.trade_atlas.detail.current_target", "Current Target");
        add("gui.ruralroutes.trade_atlas.detail.visible_routes", "Visible Routes");
        add("gui.ruralroutes.trade_atlas.detail.pending_clue", "Pending Clue");
        add("gui.ruralroutes.trade_atlas.detail.related_routes", "Visible Routes");
        add("gui.ruralroutes.trade_atlas.detail.interactions", "Interaction");
        add("gui.ruralroutes.trade_atlas.detail.hint.click_select", "Click node/segment/marker");
        add("gui.ruralroutes.trade_atlas.detail.hint.double_route", "Double-click segment/marker");
        add("gui.ruralroutes.trade_atlas.detail.hint.single_route_node", "Double-click single-route node");
        add("gui.ruralroutes.trade_atlas.detail.hint.multi_route_marker", "Use markers for shared nodes");
        add("gui.ruralroutes.trade_atlas.detail.hint.blank_drag", "Click blank to clear and drag");
        add("gui.ruralroutes.trade_atlas.detail.hint.visible_only", "Only visible routes are interactive");
        ...
        add("gui.ruralroutes.trade_atlas.detail.visible", "Visible");
        add("gui.ruralroutes.trade_atlas.detail.route", "Route");
        add("gui.ruralroutes.trade_atlas.detail.node", "Node");
        add("gui.ruralroutes.trade_atlas.detail.from", "From");
        add("gui.ruralroutes.trade_atlas.detail.to", "To");
        add("gui.ruralroutes.trade_atlas.detail.direction", "Direction");
        add("gui.ruralroutes.trade_atlas.detail.role", "Role");
        add("gui.ruralroutes.trade_atlas.detail.note", "Note");
        add("gui.ruralroutes.trade_atlas.map.player", "Player Position");
        add("gui.ruralroutes.trade_atlas.map.zoom", "Zoom %s%%");
        add("gui.ruralroutes.trade_atlas.map.center_selected", "Sel");
        add("gui.ruralroutes.trade_atlas.map.center_player", "Me");
        add("gui.ruralroutes.trade_atlas.map.center_target", "Tgt");
        ...
        add("gui.ruralroutes.trade_atlas.route.new_route_hint", "Select a node, then start a route");
        add("gui.ruralroutes.trade_atlas.route.pick_endpoint_hint", "Start %s, choose endpoint");
        ...
        add("gui.ruralroutes.trade_atlas.route.action.new", "New Route");
        add("gui.ruralroutes.trade_atlas.route.action.cancel_new", "Cancel New");
